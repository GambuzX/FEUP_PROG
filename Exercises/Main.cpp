...
void exe2_6_a() { //Determines if a number is prime or not
	int number;
	float prime = true;
	float valid = true;
...
void exe2_7_a()
{
	...
	for (int i = 0; i <= 90; i += 15)
	{
		...
		if (i % 90 == 0 && !(i % 180 == 0))
		{ // if the angle is equal to 90, 270, 450 (...), with an infinite tangent
...
int exe3_8(int m, int n) { // Algoritmo de euclides
